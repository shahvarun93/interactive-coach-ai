...
const open_ai_client_1 = require("../llm/open-ai-client");
async function generateSystemDesignQuestion(difficulty = 'medium') {
    const systemPrompt = `
...
`;
    ...
    const response = await open_ai_client_1.openai.chat.completions.create({
